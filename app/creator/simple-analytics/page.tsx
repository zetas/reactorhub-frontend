...
export default function SimpleAnalyticsPage() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      ...
      { label: 'Patron Analytics', href: '/creator/simple-analytics' }
    ]);
  }, [setBreadcrumbs]);
  ...
  const loadAnalytics = async () => {
    try {
      ...
      // Mock patron analytics data - focused on viewing behavior
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
          <div>
            ...
            <p className="text-gray-400">Track how your patrons engage with your reaction content</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          <div className="bg-gray-800 rounded-lg p-6">
            ...
            <div className="space-y-4">
              {data.content_performance.map((item, index) => (
                <div key={index} className="flex items-center justify-between p-4 bg-gray-700 rounded-lg">
                  <div className="flex items-center gap-3">
                    <div className={`w-3 h-3 rounded-full ${item.color}`}></div>
                    <div>
                      <p className="text-white font-medium truncate max-w-[200px]">{item.title}</p>
                      <p className="text-gray-400 text-sm">{item.watchTime}min avg watch time</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="text-white font-bold">{formatNumber(item.views)}</p>
                    <p className="text-gray-400 text-sm">{item.engagement}% engaged</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="bg-gray-800 rounded-lg p-6">
            ...
            <div className="space-y-4">
              {data.device_breakdown.map((item, index) => (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          <div className="bg-gray-800 rounded-lg p-6">
            ...
            <div className="space-y-4">
              {data.traffic_sources.map((item, index) => (
                <div key={index} className="flex items-center justify-between p-4 bg-gray-700 rounded-lg">
                  <div className="flex items-center gap-3">
                  ...
                  <div className="text-right">
                    <div className="text-white font-medium">{formatNumber(item.views)}</div>
        ...
        {/* Patron Insights */}
        <div className="bg-gray-800 rounded-lg p-6">
          <h3 className="text-xl font-semibold mb-6">Patron Viewing Insights</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gray-700 rounded-lg p-4">
              <h4 className="text-lg font-medium mb-3 text-purple-400">Most Popular Shows</h4>
              <div className="space-y-2">
                <div className="flex justify-between">
                  <span className="text-gray-300">Avatar: The Last Airbender</span>
                  <span className="text-white font-medium">125K views</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-300">Breaking Bad</span>
                  <span className="text-white font-medium">98K views</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-300">The Office</span>
                  <span className="text-white font-medium">87K views</span>
                </div>
              </div>
            </div>

            <div className="bg-gray-700 rounded-lg p-4">
              <h4 className="text-lg font-medium mb-3 text-green-400">Peak Viewing Times</h4>
              <div className="space-y-2">
                <div className="flex justify-between">
                  <span className="text-gray-300">8:00 PM - 10:00 PM</span>
                ...
                <div className="flex justify-between">
                  <span className="text-gray-300">12:00 PM - 2:00 PM</span>
            ...
            <div className="bg-gray-700 rounded-lg p-4">
              <h4 className="text-lg font-medium mb-3 text-blue-400">Patron Retention</h4>
              <div className="space-y-2">
                <div className="flex justify-between">
                  <span className="text-gray-300">First-time viewers</span>
                  <span className="text-white font-medium">25%</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-300">Returning patrons</span>
                  <span className="text-white font-medium">65%</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-300">Loyal subscribers</span>
